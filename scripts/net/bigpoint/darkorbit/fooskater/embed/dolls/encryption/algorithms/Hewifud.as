package net.bigpoint.darkorbit.fooskater.embed.dolls.encryption.algorithms
{
   ...
   public class Hewifud extends Kojylu
   {
      ...
      public var hilyco:Array;
      
      public var cocymawi:Array;
      
      private var vuba:uint = 0;
      
      private var welytu:uint = 0;
      
      private var key:Array;
      
      private var mymil:Array;
      
      private var fyne:Bulahonu;
      
      public function Hewifud(param1:ByteArray, param2:Rusy = null)
      {
         ...
         if(_loc4_)
         {
            ...
            if(_loc5_)
            {
               §§push((§§pop() + 1 - 1 - 21 + 1) * 55 + 1);
            }
            §§pop().mymil = new §§pop().Array(§§pop());
            if(!_loc4_)
            {
            }
            addr41:
      ...
      private function fewomone(param1:ByteArray) : Array
      {
      ...
      private function hak(param1:Array) : void
      {
         §§push(0);
         if(_loc6_)
         {
      ...
      private function dybutim(param1:Array, param2:uint) : int
      {
      ...
      public function junenut(param1:Vector.<uint>, param2:uint, param3:Vector.<uint>, param4:uint, param5:uint) : void
      {
         var _loc9_:Boolean = true;
         §§push(param4);
         if(_loc9_)
         {
            §§push(uint(§§pop() + param5));
         }
         if(_loc9_)
         {
            while(param4 < _loc6_)
      ...
      private function nuqakygac() : uint
      {
         §§push(0);
         if(_loc5_)
         {
            §§push(§§pop() * 117 * 105 - 1 + 102);
         }
         §§push(0);
         if(!_loc6_)
         {
      ...
      override public function lofanyb(param1:ByteArray) : void
      {
         ...
         if(_loc5_)
         {
            ...
            §§pop().junenut(§§pop(),§§pop(),§§pop(),§§pop(),param1.length);
         }
         if(!_loc4_)
         {
            param1.clear();
