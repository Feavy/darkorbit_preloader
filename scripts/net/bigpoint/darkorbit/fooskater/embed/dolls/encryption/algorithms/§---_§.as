package net.bigpoint.darkorbit.fooskater.embed.dolls.encryption.algorithms
{
   ...
   public class §---_§ extends §---_-__§
   {
      ...
      public function §---_§(param1:ByteArray, param2:§-__----_§ = null)
      {
      ...
      override public function §--_-__§(param1:ByteArray) : void
      {
         ...
         if(_loc5_)
         {
            ...
            §§pop().§---__-_§(§§pop(),§§pop(),§§pop(),§§pop(),param1.length);
         }
         if(!_loc4_)
         {
            param1.clear();
