package kyt
{
   ...
   public class Vurilisun
   {
      ...
      public var qabozogog:int = 40;
      
      public function Vurilisun()
      {
         var _loc1_:Boolean = true;
         var _loc2_:Boolean = false;
         if(!_loc2_)
      ...
      public function gepytykiv() : uint
      {
         var _loc1_:Boolean = true;
         var _loc2_:Boolean = false;
         §§push(0);
      ...
      public function wyfapuk() : int
      {
         var _loc1_:Boolean = false;
         var _loc2_:Boolean = true;
         return this.qabozogog;
      }
