                     ...
                     if(!_loc11_)
                     {
                        ...
                        if(!_loc11_)
                        {
                           ...
                           if(_loc10_)
                           {
                              ...
                              if(!_loc11_)
                              {
                                 for each(§--_-__-_§ in _loc5_)
                                 {
                                    if(_loc10_)
                                    {
                                       §§push(Boolean(§--_-__-_§.metadata));
                                       if(!_loc11_)
                                       {
                                          if(§§pop())
                                          {
                                             if(_loc10_)
                                             {
                                                ...
                                                if(_loc10_)
                                                {
                                                   ...
                                                   while(§§hasnext(§--_-__-_§.metadata,_loc6_))
                                                   {
                                       ...
                                       if(!_loc11_)
                                       {
                                          §§push(this.§-_____§(§--_-__-_§.@name.toString()) + ":");
                                          if(!_loc11_)
                                          {
                                             §§push(§§pop() + this.§-_-_-_§(§--__--§[§--_-__-_§.@name]));
                                          }
                                          §§push(§§pop() + §§pop());
                                       }
                                       var /*UnknownSlot*/:* = §§pop();
            ...
            if(!_loc3_)
            {
               ...
               if(_loc2_)
               {
                  if(§§pop())
                  {
                     if(!_loc3_)
                     {
                        §§push(this.§-_____§(param1 as String));
                        if(_loc2_)
                        {
                           return §§pop();
                        }
