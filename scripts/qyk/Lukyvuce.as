package qyk
{
   ...
   public class Lukyvuce
   {
      ...
      public var rizivo:int = 40;
      
      public function Lukyvuce()
      {
         var _loc1_:Boolean = true;
         var _loc2_:Boolean = false;
         if(!_loc2_)
